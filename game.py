...
# Load assets
bird_img = pygame.image.load("/home/vedant/Project/flappy-bird/images/bird.jpg").convert_alpha()
bird_img = pygame.transform.scale(bird_img, (30, 30))  # Resize the bird image
pipe_img = pygame.image.load("/home/vedant/Project/flappy-bird/images/pipe.png").convert_alpha()
